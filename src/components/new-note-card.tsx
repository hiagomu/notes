...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleContextChanged(event: ChangeEvent<HTMLTextAreaElement>) {
            ...
            <form className='flex-1 flex flex-col'>
              ...
              </div>
              {
                isRecording ? (
                  ...
                  >
                    <div className='size-3 rounded-full bg-red-500 animate-pulse'/> Gravando... (clique p/ interromper)
                  </button>
                ) : (
                  <button
                    type='button'
